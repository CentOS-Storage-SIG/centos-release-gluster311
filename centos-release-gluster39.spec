Summary: Gluster 3.11 (Short Term Stable) packages from the CentOS Storage SIG repository
Name: centos-release-gluster311
Version: 1.0
Release: 1%{?dist}
License: GPLv2
URL: http://wiki.centos.org/SpecialInterestGroup/Storage
Source0: CentOS-Gluster-3.11.repo
...
%description
yum configuration for Gluster 3.11 packages from the CentOS Storage SIG.
Gluster 3.11 is a Short Term Stable release and will receive updates for only 3
...
%install
install -D -m 644 %{SOURCE0} %{buildroot}%{_sysconfdir}/yum.repos.d/CentOS-Gluster-3.11.repo
...
%changelog
* Fri Jun 2 2017 Niels de Vos <ndevos@redhat.com> - 1.0-1
